    ...
    <div class="col col-12 col-md-3">
        ...
        <ul class="no-list footer-menu js-switchSite">
            <? if ($OptimalGroup['SITE']['CODE'] == "shop"): ?>
                <li><a href="<?= Url::Site("/ee/"); ?>" data-code="home">Электроэнергия</a></li>
                <li><a href="<?= Url::Site("/hot-water/"); ?>" data-code="home">Горячая вода</a></li>
                <li><a href="<?= Url::Site("/heating/"); ?>" data-code="home">Отопление</a></li>
            <? else: ?>
    ...
    <div class="col col-12 col-md-3 js-FooterService">
        ...
        <ul class="no-list footer-menu  js-switchSite">
            ...
            <? elseif ($OptimalGroup['SITE']['CODE'] == "shop"): ?>
                <li><a href="<?= Url::Site("/service/post/"); ?>" class="js-switchSiteLink" data-code="home">Передать
                        показания</a></li>
                <li><a href="<?= Url::Site("/service/pay/"); ?>" class="js-switchSiteLink" data-code="home">Оплатить</a>
                </li>
                <li><a href="<?= Url::Site("/service/get/"); ?>" class="js-switchSiteLink" data-code="home">Проверить
                        баланс</a></li>
                <li><a href="<?= Url::Site("/service/email/"); ?>" class="js-switchSiteLink" data-code="home">Подписка
                        на электронную квитанцию</a></li>
                <li><a href="<?= Url::Site("/service/contract/"); ?>" class="js-switchSiteLink" data-code="home">Заключить
                        договор онлайн</a></li>
                <li><a href="<?= Url::Site("/service/pc/"); ?>" class="js-switchSiteLink" data-code="home">Личный
                        кабинет клиента</a></li>
            <? else: ?>

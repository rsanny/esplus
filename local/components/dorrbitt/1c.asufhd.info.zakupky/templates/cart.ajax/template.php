        ...
        <!-- list-zakaza -->
          ...
          <div class="data-tovar<?=$class_bask?>" >
            ...
            <div class="blok" >
                ...
                ?>
              <input type="text" name="v-pole" class="v-pole-ajax" value="<?=$val["QUANTITY"]?>" data-param="1" data-val="this.value" data-ajax="<?=$arDataBase64?>" >
              <div class="plus-minus" >
                ...
                $arDataBase64 = base64_encode($arData);
                ?>
                <div class="plus plusajax" data-ajax="<?=$arDataBase64?>" data-param="1" >+</div>
                <?php
                $arData = [
                    "ACTION"=>"MINUS",
                    "TOVARID"=>$val["TOVARID"],
                ...
                $arDataBase64 = base64_encode($arData);
                ?>
                <div class="minus minusajax" data-ajax="<?=$arDataBase64?>" data-param="1" >-</div>
              </div>
            </div>
            ...
            <?=$valuta?>
                ...
                $arDataBase64 = base64_encode($arData);
                ?>
            <div class="el-remove el-removeajax" data-ajax="<?=$arDataBase64?>" data-param="1" ></div>

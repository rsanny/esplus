 ...
 */
class Atol4Branch extends Cashbox implements IPrintImmediately, ICheckable
{
	...
	public function buildCheckQuery(Check $check)
	{
        ...
        $order = \Bitrix\Sale\Order::load($check->getField('ORDER_ID'));
        $branchUrl = $this->getValueFromSettings('SERVICE', 'P_ADDRESS');

...
<? if ($arResult['arForm']['DESCRIPTION']): ?>
    <div class="popup-form--text text-center"><?= $arResult['arForm']['DESCRIPTION']; ?></div>
<? endif; ?>
<div class="row client-question">
                        <div class="col col-12 col-lg-8 col-xl-6 offset-xl-0 offset-lg-2">
<?
                    ...
                    <div class="row form-group flex-vertical">
                        ...
                        <div class="col col-12 <?= $fieldCol; ?>">
                            <div class="form-select js-select<?= $class; ?>">
                                <select 1 id="<?= $code; ?>" name="<?= $inputName; ?>">
                    ...
                    <div class="col col-12 <?= $fieldCol; ?>">
                        <div class="form-select js-select<?= $class; ?>">
                            <select id="<?= $code; ?>" name="<?= $selectName; ?>">
                                <option selected disabled value=""><?= $inputPlaceholder; ?></option>
                        ...
                        <div class="col col-12 <?= $fieldCol; ?>">
                            <div class="form-control--container">
                                <div class="form-control-file form-control<?= $class ?>">
                                    ...
                                    <input onchange="files_ajax(this.files);" name="form_file_<?= $arAnswer['ID'] ?>" class="inputfile" size="0"
                                           type="<?= $arAnswer['FIELD_TYPE'] ?>" <?= $arAnswer['FIELD_PARAM'] ?>>
                                    <div class="question form-control--question js-toolTip" data-text="Возможно загрузить не более 5 файлов общим размером до 10 МБ. Допустимые форматы файлов: jpg, jpeg, png, bmp, pdf, doc, docx, rtf, xls, xlsx. "></div>
                                    <script>
                                    ...
                                    <script>
                                        $("[data-input=<?=$arAnswer["ID"]?>]").click(function(){
                                            $(".imgandsize<?=$arAnswer["ID"]?>").html("");
                                        })
                                    </script>
                                </div>

...
if ($arSectionId){
    $rsSect = CIBlockSection::GetList(array('SORT' => 'ASC'),array('IBLOCK_ID' => $arParams['IBLOCK_ID'], 'ID' => $arSectionId, "UF_BRANCH" => $arParams['UF_BRANCH']), false, array("CODE","NAME","ID","UF_*", "PICTURE"));

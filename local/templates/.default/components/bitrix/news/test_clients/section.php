...
<?
global $clientsPage;
$clientsPage = OptimalGroup\SiteSection::Filter();
$sectionId = "";
...
if ($arResult['VARIABLES']['SECTION_CODE']){
    ...
    if ($cache->initCache("36000",  serialize($arFilter), "/iblock/clients")) 
    {
    ...
    elseif ($cache->startDataCache()) 
    {
        ...
        $CACHE_MANAGER->StartTagCache("/iblock/clients");
...
<? 
if ($arResult['VARIABLES']['SECTION_CODE'] == "odpu")
    include($_SERVER["DOCUMENT_ROOT"]."/".$this->GetFolder()."/form.odpu.php");
else

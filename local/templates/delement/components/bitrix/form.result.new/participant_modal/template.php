...
<div class="modal form-send-wrapper" id="popup-form-send">
    ...
    */
    ...
    if ($arResult["isFormNote"] != "Y") {
        ...
        <div class="form">
            ...
            <?
            $labelCol = "col-12 text-left form-label";
            $fieldCol = "col-12";
            $oneInLineCol = "col-12 text-md-left text-center";
            $hasBranch = false;
            ...
            <? if (!empty($arRequiredFields)): ?>
                ...
                if(yaCounter56389927.reachGoal('promo_1')){
                    console.log("ОК");
                } 
                 
                if(gtag('event', 'Forma_footer--FORM_PROMO_1', {'event_category': 'Forma_footer', 'event_action': 'FORM_PROMO_1', })){
                    console.log("ОК Go");
                } 
                else{
            ...
            <div class="row form-group">
                <div class="col col-12 <?= $oneInLineCol; ?>">
                    <button onClick="gtag('event', 'Forma_footer--FORM_PROMO_1', {'event_category': 'Forma_footer', 'event_action': 'FORM_PROMO_1', }); yaCounter56389927.reachGoal('promo_1'); return true;" class="btn btn-orange w-170 btn--disabled" name="web_form_submit" data-js-submit

...
//                $file['name'] = md5(file_get_contents($file['tmp_name'])) . '.' . $ext;
//            }
//        }
    }
...
$sizes=$sum_size/1024/1024+$_POST["sizes"];
    ...
    if($error===false):
        ...
        foreach($files_make_array_new as $img_arr)
        {
            ...
            if(in_array("/home/bitrix/www/local/media/icons/icon-file--doc.png",$img_arr)
                || in_array("/home/bitrix/www/local/media/icons/icon-file--exl.png",$img_arr)
                || in_array("/home/bitrix/www/local/media/icons/icon-file--pdf.png",$img_arr)
            )
            {
                $fid_file[]=$id_save;
                $fid[] = $id_save;

...
$APPLICATION->SetTitle("Заключить договор");
require($_SERVER["DOCUMENT_ROOT"]."/service/header.php");
?>

<div class="service-form service-tabs">
    <div class="form-group--title text-left text-md-center">Заключить договор Онлайн</div>
    <?
    global $arContractSection;
    $arContractSection['PROPERTY_TYPE'] = $_SESSION['BXExtra']['SITE']['ID'];
    pr($OptimalGroup['BRANCH']['ID']);
    ?>
    <? $APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "CACHE_TYPE" => "A",
            "CHECK_DATES" => "Y",
            "DETAIL_URL" => "/service/contract/#SECTION_CODE#/#ELEMENT_CODE#/",
